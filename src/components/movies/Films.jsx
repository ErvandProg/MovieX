			...
			<>
				{type === 'few' && (
					<>
						{data.map((el, index) => (
							<div
								className='w-[1660px] max-[1765px]:w-[1200px] max-[1220px]:w-[700px] flex flex-col max-[1765px]:items-center max-[1765px]:justify-center flex-wrap gap-[60px] py-[80px]'
								key={index}
							>
				...
				{(type === 'default' || type === 'paginate') && (
					<div className='w-[1660px] max-[1765px]:w-[1200px] max-[1220px]:w-[700px] flex flex-col max-[1765px]:items-center max-[1765px]:justify-center flex-wrap gap-[60px] py-[80px]'>
				...
				{type === 'liked' && (
					<div className='w-[1660px] max-[1765px]:w-[1200px] max-[1220px]:w-[700px] flex flex-col max-[1765px]:items-center max-[1765px]:justify-center flex-wrap gap-[60px] py-[105px]'>
